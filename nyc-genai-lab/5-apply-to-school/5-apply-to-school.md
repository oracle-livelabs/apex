...
13. The text for the letter generated by AI is stored in the page item **P3\_EMAIL**. In this step, we create a Page Computation to store the text in the hidden page item **P3\_LETTER** for future use. 
    *Note:* A page computation assigns a value to an identified item when a page is displayed or submitted (rendered and processed).

    In the left pane, right-click **P3\_LETTER** and select **Create Computation**.
