...
In this workshop, you create the starter Online Shopping Cart Application based on existing tables. You will also create an application from a Spreadsheet.
