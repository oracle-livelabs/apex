...
1. Navigate to page **9**. Under the **S Ord** region, select  **P9\_TOTAL** and **P9\_ORDER\_FILLED** and update type to **Hidden**. Drag **P9\_TOTAL** and drop under **P9\_PAYMENT**.

 ![App Builder](images/total-hidden.png " ")

2. While holding down the Ctrl key, click the items: P9\_DATE\_ORDERED, P9\_DATE_\SHIPPED, P9\_SALES\_REP\_ID and P9\_PAYMENT\_TYPE and update the following:
...
1. In the left pane, go to the **Processing** tab. Right-click **Validations** and select **Create Validation**.
...
2. In the Property editor, enter/select the following:
   ...
   - Under Validation:
       ...
       - SQL Expression: **:P9\_DATE\_SHIPPED > :P7\_DATE\_ORDERED**
   ...
   ![App Builder](images/validate-order.png " ")

3. Click **Save**.

## Task 3: Create the Items Report

1. Navigate to the left pane, and right-click **S Ord** region and select **Create Sub Region**.
...
2. In the Property Editor, enter/select the following:
    ...
    - Under Source:
        ...
        - Where Clause: **ORD_ID = :P9_ID**

        - Page Items to Submit: **P7\_ID**
...
Hold the Ctrl key while you click **ORD_ID** and **ITEM_ID** and change the type to **Hidden**.
...
5. In the property editor, enter/select the following:
    ...
    - Under Behavior:
        ...
        - Target: click **No Link Defined**
            ...
            - Set Items > Name: **P10_ORD_ID** , Value: **&P10_ID.**
...
1. In the left pane, go to the **Dynamic Action** tab.Right-click **Dialog Closed** and select **Create Dynamic Action**.
...
1. In the left pane, under **Buttons**, click **Cancel** and update the following:

    - Behavior > Target: **6**

    Click **OK**.

    ![App Builder](images/cancel-btn.png " ")

2. Click **Save**.

## Task 6: Run the Application

1. Run the Application and go to the **Orders - Side by Side**. Click on one of the orders created and click **Edit**.

    ![App Builder](images/compute.png " ")

2. Navigate to the **Items** report and click **Actions** menu. Select **Data > Compute**, enter/select the following:
    ...
    ![App Builder](images/compute-apply.png " ")
...
This lab involved a series of enhancements to your application's Orders Form Page. You hid non-essential fields, enforced mandatory input for critical fields, and improved the overall form usability by converting the payment type selection into a visually appealing Radio Group. Finally, you organized the form items to ensure a coherent and efficient data entry process.
