...
--   Date and Time:   05:56 Thursday August 18, 2022
...
,p_last_upd_yyyymmddhh24miss=>'20220818055643'
...
,p_last_updated_by=>'LOW_CODER'
,p_last_upd_yyyymmddhh24miss=>'20220818025947'
);
wwv_flow_imp_page.create_page_plug(
...
,p_page_component_map=>'23'
,p_last_updated_by=>'LOW_CODER'
,p_last_upd_yyyymmddhh24miss=>'20220818030727'
);
wwv_flow_imp_page.create_page_plug(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(22632422326997432865)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(22632422224976432865)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(22632423179366432867)
,p_event_id=>wwv_flow_imp.id(22632422326997432865)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
