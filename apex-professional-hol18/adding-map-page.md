...
In this Lab, You create a Map Page with Store Details and Background, and then you create an entry for the Store Details Map in the navigation Menu Entry.
...
## Task 1: Create a Store Details Map page with Background and add it to Desktop Navigation Bar.
...
15. In the Developer Toolbar, click Edit Page <n>
