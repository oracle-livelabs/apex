...
3. Enter or select the following:
    ...
    - Admin Password: Enter **`SecretPassw0rd`** for ADMIN.
    Select **Create**.
...
5. Within your new database, APEX is not yet configured. Therefore, when you first access APEX, you will need to log in as an APEX Instance Administrator to create a Workspace.
    ...
    Navigate to **Tool Configuration**. Under Oracle APEX, select **Copy** to copy the public access URL and open it in a different tab.


    ![Launch APEX instance](images/launch-apex-inst.png " ")

    > **Note:** Always Free Autonomous Database will be stopped after being inactive for 7 days. If that happens, select **More Actions**, then **Start** to start your Autonomous Database, and then **Open APEX**.

6. Enter the password for Administration Services and select **Sign In to Administration**.

    The password is the same as the one entered for the ADMIN user when creating the ATP instance: **```SecretPassw0rd```**

    ![Administration Services sign-in page](images/log-in-as-admin.png " ")
...
10. On the APEX Instance Administration page, select the **DEMO** link in the success message.

    > **Note:** This will log you out of APEX Administration so that you can log into your new Workspace.

    ![APEX Instance Administration page](images/log-out-from-admin.png " ")

11. On the APEX Workspace sign-in page, enter **`SecretPassw0rd`** for the password, check the **Remember Workspace and Username** checkbox, and then select **Sign In**.
