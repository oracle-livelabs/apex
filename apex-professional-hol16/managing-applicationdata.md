...
2. **Synchronization** is not configured yet. In this step, you provide the name of a new or existing table.
   ...
   Select **New Table** for **Synchronise To** and select **EMP** for **Table Name** and click **Save**.
...
6. Under **Create REST Data Source**, enter/select the following:
    ...
    > **Note:** _This URL endpoint consists of an array of purchase orders (denoted by the "items" attribute"), and within each purchase order, there is an array of order line items._
...
14. In the **Rendering** tab, right-click **Body** and click **Create Region**.
...
17. Now, go back to Page Designer, and look up the Array Column attribute within the Data Profile section.

18. Select **Purchase Orders** region, in the Property Editor, enter/select the following:

    - Data Profile > Array Column: **1. PO_LINEITEMS**
