...
--   Date and Time:   23:06 Friday February 18, 2022
...
,p_last_upd_yyyymmddhh24miss=>'20220218230558'
...
,p_navigation_list_template_id=>wwv_flow_api.id(25101606306703948510)
...
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'LOW_CODER'
,p_last_upd_yyyymmddhh24miss=>'20220218230459'
);
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(10781023266861112936)
,p_plug_name=>'Get Started'
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(25101547975079948465)
,p_plug_display_sequence=>20
,p_include_in_reg_disp_sel_yn=>'Y'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
