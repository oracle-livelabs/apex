...
- Add **SCM Procurement Agent** to **Operational Dashboard**
...
1. Confirm that the user you will sign in with maps to a row in `scm_application_users`.
    ...
    - create workspace users that match the sample usernames loaded in Lab 1, such as `ops.director`, `inventory.lead`, `receiving.lead`, or `fulfillment.lead`, or
