...
1. From your APEX workspace homepage, click **SQL Workshop** and select **SQL Commands**.

    !["select SQL Commands"](images/select-sql-commands.png "")

    !["select SQL Commands2"](images/select-sql-commands2.png "")
...
4. In the **App Builder** page, select your Application and then click **Shared Components**.
    ...
    !["select project management app"](images/select-app1.png "")
...
2. From Shared Components, under **Generative AI**, click **AI Agents**.

    !["click AI Agents"](images/select-ai-config1.png "")
...
5. In the newly created Generative AI Configuration, click **Tools** tab. Then, click **Add Tool**.

    !["enter system prompt"](images/click-create-rag-source.png "")

6. In the RAG Source Page, enter/select the following:
    - Under Identification, enter/select the following

        - Name: **project\_details\_query**
...
7. Click **Apply Changes**.
    ...
    !["click apply changes"](images/click-apply-changes-1.png "")
...
8. Similarly, create another item to capture Project Summary with the details mentioned below.
    ...
    | Name |  Type  |
    | --- |  --- |
    | P15\_PROJECT\_SUMMARY | Textarea |
...
12. In the Property Editor, enter the following:
    ...
    - Under Generative AI:
        - Agent: **Summarize Project Details**
        - Items to Submit: **P15\_PROJECT\_ID**

    - Under Input Value:
        - Type: **Item**
        - Item: **P15\_PROJECT\_ID**

    - Under Use Response:
        - Type: **Item**
        - Item: **P15\_PROJECT\_SUMMARY**
    - Click **Save**.
...
1. Within Page Designer, with Page 15 selected, in the Page Designer toolbar, click **Shared Components**.

    ![navigate to shared components](images/navigate-to-shared-comp2.png " ")

    Alternatively, from the application home page, click **Shared Components**.

2. From Shared Components, under **Generative AI**, click **AI Agents**.

    !["click AI configurations"](images/select-ai-config2.png "")

3. Select the Previously created AI Tool. Click **Summarize Project Details**.

    !["click summarize project details"](images/click-summarize-ai.png "")

4. In the Generative AI Agents page, Under Tools tab, click **Project Details Query**.
...
5. You will not add a where clause to the existing SQL Query. Under Source, for SQL Query, append the below where clause. Then, click **Apply Changes**.
    ...
    **Full Query**:
    ...
    >**Note**: The page item P15\_PROJECT\_ID may vary depending on the page number created in Task 3 of this lab. Ensure that the page number in the item aligns with the page number you used.
