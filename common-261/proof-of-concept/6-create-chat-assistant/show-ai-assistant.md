...
6. In the Generative AI Tool Page, enter the following:
    - Under Identification, enter/select the following:

        - Name: **project_details_query**
...
5. Right click on the newly created button and then click **Create Trigger Action**.

    ![click create trigger action](./images/create-da1.png " ")
...
3. Play around with the Chat Assistant and ask any question related to the selected project.
    ...
    ![interact with chat assistant](images/chat-with-ai3.png " ")
